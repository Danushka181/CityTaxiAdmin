...
form.email = props.driver.email;
form.phone = props.driver.phone;
form.address = props.driver.address;
form.license_number = props.driver.license_number;
form.identity_card = props.driver.identity_card;
form.hire_rate = props.driver.hire_rate;
form.status = props.driver.status;
form.is_banned = props.driver.is_banned;
                    ...
                    <div class="drivers-list">
                        <div class="">
                            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg py-3 px-4">
                                <div class="text-gray-900 text-2xl">Driver : {{form.name}}</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <form @submit="sumitEditDriver">
                            ...
                            <div class="row">
                                <div class="mb-3 col-6">
                                    ...
                                    <input :readonly="isReadOnly" type="text" v-model="form.license_number" class="form-control" id="license_number">
                                    <div v-if="form.errors.license_number" class="form-text text-red-600">{{form.errors.license_number}}</div>
                                </div>
                                <div class="mb-3 col-6">
                            ...
                            <div class="row">
                                <div class="mb-3 col-6">
                                    <label for="hire_rate" class="form-label">Hire Rate</label>
                                    <input :readonly="isReadOnly" type="text" v-model="form.hire_rate" name="hire_rate" class="form-control" id="hire_rate">
                                    <div v-if="form.errors.hire_rate" class="form-text text-red-600">{{ form.errors.hire_rate }}</div>
                                </div>
                                <div class="mb-3 col-6">
                            ...
                            <div class="row">
                                <div class="mb-3 col-12">
                                    <label for="is_banned" class="form-label">Banned This Driver</label>
